...
const actions = {
  async add({ commit }, { docId, payload }) {
    ...
    try {
      ...
      $log.debug('user | add | id, dirty', docId, dirty)
  ...
  async update({ commit }, { docId, payload }) {
    ...
    try {
      ...
      $log.debug('user | update | dirty', dirty)
